        ...
        <section className='bg-base-200'>
            <footer className="footer p-10 text-base-content container mx-auto">
                ...
                <div>
                    ...
                    <a className="link link-hover">Facebook: /toykingdom</a>
                    <a className="link link-hover">Twitter: @toykingdom</a>
                    <a className="link link-hover">Instagram: @toykingdom</a>
                </div>
                <div>
            ...
            <footer className="footer px-10 py-4 border-t items-center text-base-content border-base-300 container mx-auto">
                <div className="items-center grid-flow-col">
                    <img src={logo} className='text-cyan-500' alt="" />
                    <p>Toys KingDom <br />Welcome to a new world!</p>
                </div>
                <div>
                    <span>© All Rights Reserved 2021-2026</span>
                </div>
